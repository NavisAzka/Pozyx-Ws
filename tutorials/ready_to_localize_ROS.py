...
class ReadyToLocalize(object):
    ...
    def __init__(self, pozyx, osc_udp_client, anchors, algorithm=POZYX_POS_ALG_UWB_ONLY, dimension=POZYX_3D, height=1000, remote_id=None):
        ...
        self.odom_pub = rospy.Publisher('/pozyx/odometry', Point, queue_size = 1)
    ...
    def printPublishPosition(self, position):
        odom_msg = Point()
        odom_msg.x = position.x
        odom_msg.y = position.y
        odom_msg.z = 0
...
if __name__ == "__main__":
    ...
    remote_id = 0x6800                 # remote device network ID
    ...
    anchors = [DeviceCoordinates(0x671D, 1, Coordinates(-3000, 1200, 1000)),
               DeviceCoordinates(0x6722, 1, Coordinates(-700, 4700, 450)),
               DeviceCoordinates(0x6764, 1, Coordinates(7600, 800, 1680)),
               DeviceCoordinates(0x6772, 1, Coordinates(7100, 5400, 1150))]
